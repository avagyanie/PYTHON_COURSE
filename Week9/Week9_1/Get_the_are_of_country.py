"""
Create a function that takes a country's name and its area as arguments and returns the area of
the country's proportion of the total world's landmass.
Examples
...
def area_of_country(country: str, area: int) -> str:
    total = 148940000
    proportion = area / total * 100
    return f"{country} is {proportion:.2f}% of the total world's landmass"
