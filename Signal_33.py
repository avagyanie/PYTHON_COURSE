...
Example
    ...
    There are 6 possible arrangements for these strings:
        ...
        ["bab", "bbb", "aba"]
        ["bab", "aba", "bbb"]
    None of these satisfy the condition of consecutive strings differing by 1 character, so the answer is 
    false.
...
def isChainPossible(startIndex, array):
    ...
    for i in range(len(newArray)):
        if differsByOne(array[startIndex], newArray[i]) and isChainPossible(i, newArray):
            return True
    return False
